...
当前为 `Wave 0 / Bootstrap`：

- 只建立文档、架构决策、迁移规则和开发流程。
- 尚未迁移 V1 代码。
- 尚未确定具体框架依赖和数据库 schema。
- 尚未发布 Runtime Contracts 实施 Issue。

## 下一步

Bootstrap PR 合并后：

1. 主对话发布 Runtime Contracts Issue。
2. 建立最小模块骨架和纯契约测试。
3. 冻结 TaskFrame、Plan、Workspace、Event、Receipt 和 Diff 接口。
4. 再发布可并行的实现 Issue。
